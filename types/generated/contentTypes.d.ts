...
export interface ApiAlojamientoAlojamiento extends Schema.CollectionType {
...
export interface ApiReservaReserva extends Schema.CollectionType {
  ...
  attributes: {
    fechaDesde: Attribute.Date & Attribute.Required;
    fechaHasta: Attribute.Date & Attribute.Required;
    fechaReserva: Attribute.Date & Attribute.Required;
    telefono: Attribute.Integer;
    cliente: Attribute.Relation<
      ...
      'api::cliente.cliente'
    >;
    alojamiento: Attribute.Relation<
      'api::reserva.reserva',
      'oneToOne',
      'api::alojamiento.alojamiento'
    >;
